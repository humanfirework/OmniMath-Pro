...
interface FormulaRendererProps {
  ...
  maxHeight?: number;
  /** Hide the horizontal scrollbar until the user hovers the formula. */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'overflow-x-auto',
          scrollbarOnHover && 'formula-scroll-hover',
          displayMode && 'py-1',
      ...
      >
        <div
          ...
          className={displayMode ? 'katex-formula-content' : 'inline'}
          style={{
